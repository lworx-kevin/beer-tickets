<%@ Page Title="" Language="C#" MasterPageFile="~/VGC.master" AutoEventWireup="true" CodeFile="CouponTypes.aspx.cs" Inherits="CouponCategory" %>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <label class="control-label col-sm-4"  for="txtCatCode">Type:</label>
                                    <div class="col-sm-8">
                                        <input type="text" maxlength="2" class="form-control" id="txtCatCode" onkeypress="return onlyAlphabets(event,this);"  name="txtCatCode" placeholder="Type Code" required>
                                    </div>
                                </div>
                                  <div class="form-group">
    ...
    <script src="Pages/Type.js"></script>
        ...
        {%>alert("You don't have rights to perform this action."); return false;<%}%>
                      ...
                      function () {
                          ...
                          $.ajax({
                              type: "POST",
                              url: "CouponTypes.aspx/DeleteCouponCategoryById",
                              dataType: "json",
                  ...
                  function BindTable() {
                      ...
                      $.ajax({
                          type: "POST",
                          url: "CouponTypes.aspx/GetCouponCategories",
                          dataType: "json",
                          data: "{}",
                          contentType: "application/json; charset=utf-8",
                          async: true,
