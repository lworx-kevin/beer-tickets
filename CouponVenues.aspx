<%@ Page Title="" Language="C#" MasterPageFile="~/VGC.master" AutoEventWireup="true" CodeFile="CouponVenues.aspx.cs" Inherits="CouponTypes" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContainer" Runat="Server">
    ...
    <div class="panel panel-info">
        <div class="panel-heading">
            <div class="row">
                <div class="col-sm-8">
                    <h4 class="text-primary">Coupon Venues</h4>
                </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Coupon Venues Master Form in
...
<asp:Content ID="Content2" ContentPlaceHolderID="ctlscript" Runat="Server">
    ...
    <script src="Pages/Venue.js"></script>
    ...
    {%>alert("You don't have rights to perform this action."); return false;<%}%>
            ...
            function () {
                ...
                $.ajax({
                    type: "POST",
                    url: "CouponVenues.aspx/DeleteCouponTypeById",
                    dataType: "json",
        ...
        function BindTable() {
            ...
            $.ajax({
                type: "POST",
                url: "CouponVenues.aspx/GetCouponTypes",
                dataType: "json",
                data: "{}",
                contentType: "application/json; charset=utf-8",
                async: true,
